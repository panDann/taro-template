...
/** 拖车子订单物流状态 */
export const btnRemark = [{ key: "0", value: "确认出发" }, { key: "1", value: "装货" }, { key: "2", value: "到达" }, { key: "3", value: "" }];
/**保险公司类型 */
...
/**拼箱下单：货物包装 */
export const cargoPacking = ["木托盘", "胶托盘", "铁托盘", "纸箱", "木箱", "航空箱", "泡沫箱", "袋卷", "桶", "其他"];
/**熏蒸服务--货物包装 */
export const fumigateServicePacking = ["木托", "木箱", "木板", "木条"];
/**熏蒸服务--货物包装 */
export const fumigateServicePacking1 = [{ key: "1", value: "木托" }, { key: "2", value: "木箱" }, { key: "3", value: "木板" }, { key: "4", value: "木条" }];
/**
 * 订单类型：1、2、3==整箱、拼箱、拖车
 */
